...
<div class="wrap">	
	<div class="Free_Quotation_header"></div> <h2>Free Quotation <?php echo $Free_Quotation_version; ?><a class="add-new-h2" href="admin.php?page=fq_add_CSV">Add Multiple Free Quotations in CSV</a></h2></h2>
	<h4>All quotation</h4>
<?php	
...
<script type="text/javascript">
	...
	<div class="Free_Quotation_wrap3">
		...
		<?php 
			...
			$fqshowtable = $wpdb->get_results("SELECT * FROM $table_name WHERE id ORDER BY id DESC LIMIT 0, 10", OBJECT_K);
